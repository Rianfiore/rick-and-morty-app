      ...
      >
        {
          <>
            <div className="modal__header">
              <h2 className="modal__header__title">Identification Card</h2>
              <button
                onClick={() => {
                ...
                className="modal__header__exit-button"
                type="submit"
              >
                X
              </button>
            ...
            <div className="modal__content">
              <div className="modal__content__details">
                <div className="modal__content__label">
                  <h4>ID: </h4>
                  <p>{`${modal.id}`}</p>
                </div>
                <div className="modal__content__label">
              ...
              <div className="modal__content__main">
                <div className="modal__content__main__photo">
                  <div className="modal__content__main__photo__img">
                    <Image src={modal.image} alt="" width={200} height={200} />
                  </div>
                  <div className="modal__content__main__photo__status">
                    <div className="modal__content__label">
                      <h4>Status: </h4>
                      <p>{`${modal.status}`}</p>
                    </div>
                ...
                <div className="modal__content__main__title">
                  <h1 className="modal__content__main__title__name">
                    {modal.name}
                  </h1>
                  <h2 className="modal__content__main__title__origin">
            ...
            <div className="modal__footer">
              <div className="modal__footer__details">
                <div className="modal__footer__label">
                  <h4>Location: </h4>
